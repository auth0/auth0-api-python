...
class ApiClientOptions:
    ...
    Args:
        domain: The Auth0 domain, e.g., "my-tenant.us.auth0.com" (for single issuer mode).
        ...
        issuer_cache_ttl: Cache TTL in seconds for issuer validation (default: 3600).
