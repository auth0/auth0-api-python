...
class ApiClient:
    ...
    async def get_token_by_exchange_profile(
        ...
        try:
            timeout_value = self.options.timeout if self.options.timeout is not None else 10.0
    ...
    def _apply_extra(
        ...
        Raises:
            GetTokenByExchangeProfileError: If reserved parameter or array size limit exceeded
        """
